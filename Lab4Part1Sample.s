...
Reset_Handler
	LDR r0, =green ; green starts at 20000004
	LDR r5, =yellow ; yellow starts at 20000000
	
	LDRB r1, [r0,#3]!  ;pre index updating base by 3 each time so it gets the correct byte we need
	LDRB r2, [r0,#3]!
	LDRB r3, [r0,#3]!
	LDRB r4, [r0,#3]!
	
	ADD r6, r1, r2 ; adds together the registers and stores them stores them in r5
	ADD r7, r3, r4
	ADD r9, r6, r7
	
	STR r9, [r5]		; stores r5 into r5 memory

stop B stop			; stop code
green DCD 0x6A444444, 0x33D03333, 0x22224122, 0x1111110C;
		AREA Lab_4_Data, DATA, READWRITE
yellow DCD 0;
		end